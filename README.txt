...
Data: 25-channel EEG, 5 minutes per 19 subjects, already notch filtered (60 Hz), high-pass filtered (0.1 Hz), and re-referenced using common average referencing (CAR).
